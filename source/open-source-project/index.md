...
## cocos2d-hitplane
### 项目简介
基于cocos2d-js开发的打飞机游戏。
### 项目地址
[https://github.com/xialeistudio/cocos2d-hitplane](https://github.com/xialeistudio/cocos2d-hitplane)

## hostManager
### 项目简介
Google Chrome的hosts管理插件，但是Chrome由于安全限制，本插件已失去作用。有需要开发插件的朋友可以参数一下。
### 项目地址
...
## angular-upload
### 项目简介
angular上传指令，支持多文件上传，支持上传进度支持多文件上传，支持上传进度。
### 项目地址
...
### 项目地址
[https://github.com/xialeistudio/angular-toggle](https://github.com/xialeistudio/angular-toggle)
...
微信右上角弹出菜单效果。
### 项目地址
[https://github.com/xialeistudio/wechat-like-menu](https://github.com/xialeistudio/wechat-like-menu)
...
### 项目简介
基于mybatis-generator的gui版本，使用swing开发。
### 项目地址
[https://github.com/xialeistudio/mybatis-generator-gui](https://github.com/xialeistudio/mybatis-generator-gui)
### 项目背景
官方提供的mybatis-generator只有命令行接口，不便于开发，故开发了本程序。
